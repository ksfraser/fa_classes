...
class fa_bank_accounts extends table_interface
{
	...
	function __construct( $caller = null )
	{
		...
		$this->table_details['primarykey'] = "id";
		 ...
		 $this->fields_array[] = array('name' => 'dflt_curr_act', 'type' => 'tinyint(2)   ',  'readwrite' => 'readwrite',  'label' => '', 'default' => '0'  );	//   |
	...
	* @since 20250408
	*
	* @param string|null account number
	* @returns array 1D array of the account selected by NUMBER
	*************************************************************************/
	/*@bool@*/function getByBankAccountNumber( $bank_account_number )
	{
		$this->set( "bank_account_number", $bank_account_number );
		$fields = "*";	//comma separated list
		$where = array('bank_account_number' => $bank_account_number );
		$orderby = array();
		$limit = null;	//int
		$this->properties_array[] = 'bank_account_number';
		//$this->properties_array = [ 'bank_account_number' ];
		$this->select_table( $fields, $where, $orderby, $limit );
		$ret = $this->db_fetch_assoc();
		return $ret[0];
		//return $this->db_fetch_assoc();
	}
	/**//********************************************************************
	* Search for an account by the account name
	*
	* @since 20250408
	*
	* @param string|null account name
	* @returns array
	*************************************************************************/
	/*@bool@*/function getByBankAccountName( $bank_account_name = "")
	{	
		if( isset( $name ) )
		{
			$this->set( "bank_account_name", $bank_account_name );
		}
		$this->getByName();
		return $this->db_fetch_assoc();
	}
	/*@bool@*/function getByName()
	{
		...
		$orderby = array();
		$limit = null;	//int
		$this->properties_array[] = 'bank_account_name';
