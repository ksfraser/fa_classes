...
/**
 * @deprecated 2026-07-09 Replaced by StockCategoryDTO + StockCategoryRepository (src/FrontAccounting/DTO/StockCategory.php, Repository/StockCategoryRepository.php).
 */
...
| dflt_no_sale        | tinyint(1)  | NO   |     | 0       |                |
	...
	function __construct( $caller = null )
	{
		...
		$this->table_details['tablename'] = TB_PREF . 'stock_category';
