...
class fa_bank_transfer extends fa_origin
{
	...
	protected $FromBankAccount;	//Bank Account NOT GL
	protected $ToBankAccount;	//Bank Account NOT GL
	protected $charge;		//Charge amount
	protected $amount;		//NET amount
	protected $target_amount;	//Target in FOREIGN CURRENCY
