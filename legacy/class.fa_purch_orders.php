...
/**
 * @deprecated 2026-07-09 Replaced by PurchaseOrderDTO + PurchaseOrderRepository (src/FrontAccounting/DTO/PurchaseOrder.php, Repository/PurchaseOrderRepository.php).
 */
 ...
 *
 * **********************************************************/
class fa_purch_orders extends fa_table_wrapper
{
	var $min_cid;
	var $max_cid;
	var $errors = array();
...
| ord_date            | date       | NO   | MUL | 0000-00-00 |                |
| reference           | tinytext   | NO   |     | NULL       |                |
| requisition_no      | tinytext   | YES  |     | NULL       |                |
| into_stock_location | varchar(5) | NO   |     |            |                |
| delivery_address    | tinytext   | NO   |     | NULL       |                |
| total               | double     | NO   |     | 0          |                |
| tax_included        | tinyint(1) | NO   |     | 0          |                |
	 *
	 * */
	protected $order_no            ;// int(11)    | NO   | PRI | NULL       | auto_increment |
	protected $supplier_id         ;// int(11)    | NO   |     | 0          |                |
	protected $comments            ;// tinytext   | YES  |     | NULL       |                |
	protected $ord_date            ;// date       | NO   | MUL | 0000-00-00 |                |
	protected $reference           ;// tinytext   | NO   |     | NULL       |                |
	protected $requisition_no      ;// tinytext   | YES  |     | NULL       |                |
	protected $into_stock_location ;// varchar(5) | NO   |     |            |                |
